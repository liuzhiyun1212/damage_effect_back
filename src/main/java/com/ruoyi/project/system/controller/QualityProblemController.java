...
//        LoginUser loginUser = tokenService.getLoginUser(ServletUtils.getRequest());
    ...
    public List season(Sum sum) {
        ...
        for (int i = 0; i < listall.size(); i++) {
            ...
            if (i + 2 < listall.size()) {
                if ((listall.get(i).getSum() * 1.2 < listall.get(i + 1).getSum() && listall.get(i + 1).getSum() * 1.2 < listall.get(i + 2).getSum()) || (listall.get(i).getSum() * 0.8 > listall.get(i + 1).getSum() && listall.get(i + 1).getSum() * 0.8 > listall.get(i + 2).getSum())) {
                    if (mark == 1) {
                ...
                if ((listall.get(i).getSum() < listall.get(i + 1).getSum() && listall.get(i + 1).getSum() < listall.get(i + 2).getSum()) || (listall.get(i).getSum() > listall.get(i + 1).getSum() && listall.get(i + 1).getSum() > listall.get(i + 2).getSum())) {
                    if (mark == 1) {
    ...
    public List<Sum> twoTime(List<Sum> list) {
        ...
        for (int i = 0; i < list.size() - 2; i++) {
            if ((list.get(i).getSum() * 1.2 < list.get(i + 1).getSum() && list.get(i + 1).getSum() * 1.2 < list.get(i + 2).getSum()) || (list.get(i).getSum() * 0.8 > list.get(i + 1).getSum() && list.get(i + 1).getSum() * 0.8 > list.get(i + 2).getSum())) {
    ...
    public List<Sum> threeTime(List<Sum> list) {
        ...
        for (int i = 0; i < list.size() - 2; i++) {
            if ((list.get(i).getSum() < list.get(i + 1).getSum() && list.get(i + 1).getSum() < list.get(i + 2).getSum()) || (list.get(i).getSum() > list.get(i + 1).getSum() && list.get(i + 1).getSum() > list.get(i + 2).getSum())) {
...
//        System.out.println("测试aaaaaaaaa" + res);
    ...
    static class time1 {
        ...
        public String toString() {
            return "Time1{" + "name='" + name + '\'' + ", list=" + list + '}';
        }
    }
    ...
    static class timeCount {
        ...
        @Override
        public String toString() {
            return "TimeCount{" + "name='" + name + '\'' + ", time=" + time + '}';
        }
    }
